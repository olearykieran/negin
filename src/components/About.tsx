...
export function About() {
  return (
    <section id="about" className="py-16 px-6 bg-black text-white text-center">
      <h2 className="text-3xl font-canela mb-6">About Me</h2>
      <p className="font-canela text-lg max-w-2xl mx-auto">
